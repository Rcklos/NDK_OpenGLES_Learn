...
typealias OnWheelChangedListener = (
    @ParameterName("angle") Double
) -> Unit
...
class RockerView @JvmOverloads constructor(
    ...
    private fun drawSelf(canvas: Canvas) {
        ...
        if (onSteeringWheelChangedListener != null || onWheelChangedListener != null) {
            // 计算两点之间距离
            ...
            onWheelChangedListener?.invoke(angle)
            // 算出弧度
    ...
    fun setOnWheelChangedListener(listener: OnWheelChangedListener?) = run {
